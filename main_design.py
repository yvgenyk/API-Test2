...
"color: rgb(204,204,204);"))
        ...
        self.ad_proj = QtGui.QPushButton(self.horizontalLayoutWidget_2)
        self.ad_proj.setMinimumSize(QtCore.QSize(375, 60))
        self.ad_proj.setMaximumSize(QtCore.QSize(375, 60))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.ad_proj.setFont(font)
        self.ad_proj.setCursor(QtGui.QCursor(QtCore.Qt.OpenHandCursor))
        self.ad_proj.setStyleSheet(_fromUtf8("background:rgb(80,80,80);\n"
"color: rgb(204,204,204);"))
        self.ad_proj.setObjectName(_fromUtf8("ad_proj"))
        self.verticalLayout.addWidget(self.ad_proj)
